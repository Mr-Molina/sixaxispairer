...
REM Fix popen/pclose for Windows
powershell -Command "(Get-Content controller_connection.c) -replace 'popen', '_popen' -replace 'pclose', '_pclose' | Set-Content temp\controller_connection.c"
